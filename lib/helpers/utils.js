    ...
    htmlRemoveBetween: function (data, tagName) {
        ...
        for (var i = 0; i < data.length; i++){
            ...
            if (status === "started") {
                ...
                if (!(curBetween in between))
                    between[curBetween] = "";
                between[curBetween] += c;
        ...
        return {data: data_fin, between: between};
    },

    disablePHP: function (data) {
        var start = "<?",
            pos = 0,
            status = "null",
            end = "?>",
        ...
        for (var i = 0; i < data.length; i++){
            ...
            if (status === "null") {
                ...
                if (pos === start.length) {
                    ...
                    preend_buf = "";
                    pos = 0;
                    data_fin = data_fin.replace(new RegExp(".{"+start.length+"}$"), "  ");
