            ...
            fs.readFile("docs/readme.md", "utf8", function(err, data) {
                ...
                for (var i in supported_languages) {
                    ...
                    switch (supported_languages[i]) {
                        case "CPP":
                            supported_languages[i] = "C++";
                            break;
                        case "CS":
                            supported_languages[i] = "C#";
                            break;
                        case "JAVA":
                            supported_languages[i] = "Java";
                            break;
                        case "FEATURE":
                            supported_languages[i] = "Gherkin";
                            break;
                        case "JS":
                            supported_languages[i] = "JavaScript";
                            break;
                        case "PY":
                            supported_languages[i] = "Python";
                            break;
                        case "RB":
                            supported_languages[i] = "Ruby";
                            break;
                    }
                }
