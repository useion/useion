...
module.exports = function () {
    ...
    this.update = {
        ...
        html:   ["unknown", "comment", "template"],// "assignment", "comment", "function", "function-call", "assignment", "class", "statement"],
        tpl:    ["unknown", "comment", "template"],// "assignment", "comment", "function", "function-call", "assignment", "class", "statement"],
        css:    ["comment"],
        js:     ["assignment", "comment", "function", "function-call", "assignment", "statement"],
                    ...
                    case "full":
                        ...
                        if (!changeBlock.error) {
                            for (var i in merge_these_fragments) {
                                ...
                                if (fragment.strategy && fragment.strategy === "=") {
                                    fragment.last_body = fragment.body;
                                    fragment.body = change.body;
                                    merge_these_fragments[i] = fragment;
                                    continue;
                                }
                                //console.log('!!!',fragmentBlock.tree);
                                //console.log(logger.logTree(changeBlock.tree));
                                //console.log('LANG!', fragment.lang, fragment.path);
                                //logger.logTree(fragmentBlock.tree);
                    ...
                    case "partial":
                        ...
                        if (!changeBlock.error) {
                            ...
                            for (var i in merge_these_fragments) {
                                ...
                                if (fragment.type === "full" && change.strategy === "=") {
                                    fragment.last_body = fragment.body;
                                    fragment.body = change.body;
                                    merge_these_fragments[i] = fragment;
                                    continue;
