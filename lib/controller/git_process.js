...
//        return date.getDate() + "." + (date.getMonth()+1) + "." + date.getFullYear() + " " + strTime;
    ...
    model = require('../model')(function (err, db) {
        ...
        process.on('message', function(obj) {
            ...
            // if (commit_sha.substring(0, 7) !== "df5647c") {
            //     process.send("skip");
            //     process.kill(process.pid);
            //     return true;
            // }
                                    ...
                                    commit_db.save(function (err) {
                                        ...
                                        if (Object.keys(usecase_commit_within).length > 0)
                                            for (var uc in usecase_commit_within) {
                                                ...
                                                withins.push(saveWithin(uc, commit_db, (((100*withinSum)/(changeSum))), withinSum))
                                        ...
                                        Promise.all(withins).then(function () {
                                            ...
                                            logger.log(formatDate(new Date())+'  Commit '+ commit.sha().substring(0, 7)+' finished')
